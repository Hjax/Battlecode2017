...
public class AllyData {
	...
	public AllyData(long memoryData) {
	...
	public static boolean isAlive(long memoryData){
		//return Utilities.bitInterval(memoryData, 0, 0) == 1;
		// 0 0 is the same as & 1
		return (memoryData & 1) == 1;
	}
	
	public static int getType(long memoryData) {
		return Utilities.bitInterval(memoryData, 28, 30);
	}
	
	public static int getLocInt(long memoryData){
