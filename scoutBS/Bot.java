...
public class Bot {
    ...
    public static Direction neo() throws GameActionException
    {
    	...
    	{
    		RobotInfo[] engageBots = rc.senseNearbyRobots(-1, enemy);
    	...
    	if (rc.getType() == RobotType.GARDENER && behaviorType == 0 && false)
    	{
    	...
    	if (rc.getType() != RobotType.GARDENER && rc.getType() != RobotType.ARCHON && rc.getType() != RobotType.SCOUT)
    	{
