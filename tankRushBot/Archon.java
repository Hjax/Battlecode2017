	...
	public static void Start(RobotController RobCon) throws GameActionException{
        ...
        while (true) {
            ...
            try 
            {
                ...
                if ((Globals.getGardenerCount() < 1 || Globals.getTrainerCount() < 1) && ((round == 1 && isFirst) || (rc.senseNearbyRobots().length > 1 && rc.getTeamBullets() >= 400) || (round > 100 && Globals.getGardenerCount() == 0)))
                	{tryBuild = true;}
